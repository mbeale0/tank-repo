...
namespace Tank
{
    public class TankMovement : MonoBehaviour
    {
        ...
        private ParticleSystem[] _mParticleSystems; // References to all the particles systems used by the Tanks
        ...
        private void OnEnable ()
        {
            ...
            _mParticleSystems = GetComponentsInChildren<ParticleSystem>();
            for (int i = 0; i < _mParticleSystems.Length; ++i)
            {
                _mParticleSystems[i].Play();
            }
        }
        ...
        private void OnDisable ()
        {
            ...
            foreach (var t in _mParticleSystems)
            {
                t.Stop();
            }
        }
        ...
        private void Update ()
        {
            ...
            {
                AkSoundEngine.PostEvent("Stop_Tank_Moving", gameObject);
            }
